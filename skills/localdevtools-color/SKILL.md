---
name: localdevtools-color
description: Convert a clipboard color to other formats, derive color harmonies and find the nearest Tailwind color locally.
---
...
Run `node scripts/run.mjs color convert --clipboard`. Results include hex, RGB, HSL, HWB, CMYK, harmonies and nearest Tailwind color. The result is returned directly to the agent.
